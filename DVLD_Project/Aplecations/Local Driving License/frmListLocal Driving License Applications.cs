...
using DVLD_Project.Aplecations.Test;
...
{
    public partial class frmLocal_Driving_License_Applications : Form
    {


        private DataTable _dtAllLocalDrivingLicenseApplications;
        public frmLocal_Driving_License_Applications()
        {
            InitializeComponent();
        }

        private void frmLocal_Driving_License_Applications_Load(object sender, EventArgs e)
        {
        ...
        private void _ScheduleTest(clsTestType.enTestType TestType)
        {
            ...
            frm.ShowDialog();
            //refresh
            frmLocal_Driving_License_Applications_Load(null, null);
        ...
        private void showLicenseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int LicenseID = clsLocalDrivingLicenseApplications.FindByLocalDrivingAppLicenseID(
