...
namespace DVLD_Business
{
    public class clsTestAppointment
    {
        ...
        private bool _AddNewTestAppointment()
        {
            ...
            this.TestAppointmentID = clsTestAppoimentData.AddNewTestAppointment((int)this.TestTypeID, this.LocalDrivingLicenseApplicationID,
        ...
        private bool _UpdateTestAppointment()
        {
            ...
            return clsTestAppoimentData.UpdateTestAppointment(this.TestAppointmentID, (int)this.TestTypeID, this.LocalDrivingLicenseApplicationID,
        ...
        public static clsTestAppointment Find(int TestAppointmentID)
        {
            ...
            if (clsTestAppoimentData.GetTestAppointmentInfoByID(TestAppointmentID, ref TestTypeID, ref LocalDrivingLicenseApplicationID,
        ...
        public static clsTestAppointment GetLastTestAppointment(int LocalDrivingLicenseApplicationID, clsTestType.enTestType TestTypeID)
        {
            ...
            if (clsTestAppoimentData.GetLastTestAppointment(LocalDrivingLicenseApplicationID, (int)TestTypeID,
        ...
        {
            return clsTestAppoimentData.GetAllTestAppointments();

        }

        public DataTable GetApplicationTestAppointmentsPerTestType(clsTestType.enTestType TestTypeID)
        {
            return clsTestAppoimentData.GetApplicationTestAppointmentsPerTestType(this.LocalDrivingLicenseApplicationID, (int)TestTypeID);
        ...
        {
            return clsTestAppoimentData.GetApplicationTestAppointmentsPerTestType(LocalDrivingLicenseApplicationID, (int)TestTypeID);
        ...
        {
            return clsTestAppoimentData.GetTestID(TestAppointmentID);
        }
