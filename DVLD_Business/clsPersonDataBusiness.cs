...
{
    public class clsPersonDataBusiness
    {
        ...
        private clsPersonDataBusiness(int PersonID, string FirstName, string SecondName, string ThirdName,
        ...
        public static clsPersonDataBusiness Find(int PersonID)
        {
            ...
            if (IsFound)
                ...
                return new clsPersonDataBusiness(PersonID, FirstName, SecondName, ThirdName, LastName,
                          NationalNo, DateOfBirth, Gendor, Address, Phone, Email, NationalityCountryID, ImagePath);
            else
                return null;
        }

        public static clsPersonDataBusiness Find(string NationalNo)
        {
